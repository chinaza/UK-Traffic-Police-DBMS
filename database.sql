...
INSERT INTO Incident
  (incident_ID, vehicle_ID, people_ID, incident_Date, incident_Report, offence_ID)
VALUES
...
INSERT INTO Offence
  (offence_ID, offence_description, offence_maxFine, offence_maxPoints)
VALUES
  (1, 'Speeding', 1000, 3),
...
INSERT INTO People
  (people_ID, people_name, people_address, people_licence)
VALUES
...
,
ADD KEY fk_incident_vehicle
(vehicle_ID),
ADD KEY fk_incident_people
(people_ID),
ADD KEY fk_incident_offence
(offence_ID);
...
,
ADD CONSTRAINT fk_incident_people FOREIGN KEY
(people_ID) REFERENCES People
(people_ID),
ADD CONSTRAINT fk_incident_vehicle FOREIGN KEY
...
,
ADD CONSTRAINT fk_vehicle FOREIGN KEY
(vehicle_ID) REFERENCES Vehicle
(vehicle_ID);
